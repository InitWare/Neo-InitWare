...
import { Job, Scheduler } from './iw.mjs'
import * as fs from './fs.mjs';
import * as path from './path.mjs'

const Edge = Scheduler.Edge;
...
let dependencyToEdgeTypes = {
	"Before": Edge.kBefore,
	"Requires": Edge.kAddStart | Edge.kStartOnStarted,
	"Wants": Edge.kAddStartNonreq | Edge.kTryStartOnStarted,
	"PartOf": 0,
	"BindsTo": Edge.kAddStart | Edge.kStartOnStarted,
	"Requisite": Edge.kAddVerify,
	"Triggers": 0,
	"Conflicts": Edge.kAddStop,
	"Upholds": Edge.kAddStartNonreq | Edge.kStartOnStarted,
	"PropagatesReloadTo": Edge.kPropagatesReloadTo,
	"PropagatesStopTo": Edge.kPropagatesStopTo,

	"After": Edge.kAfter,
	"RequiredBy": Edge.kPropagatesStopTo | Edge.kPropagatesRestartTo,
	"WantedBy": 0,
	"ConsistsOf": Edge.kPropagatesStopTo | Edge.kPropagatesRestartTo,
	"BoundBy": Edge.kStopOnStopped | Edge.kPropagatesStopTo |
		Edge.kPropagatesRestartTo,
	"RequisiteOf": Edge.kPropagatesStopTo | Edge.kPropagatesRestartTo,
	"TriggeredBy": 0,
	"ConflictedBy": Edge.kAddStopNonreq,
	"UpheldBy": 0,
	...
	"JoinsNamespaceOf": 0,
	"Following": 0,
	"OnSuccess": Edge.kOnSuccess,
	"OnFailure": Edge.kOnFailure,
};
